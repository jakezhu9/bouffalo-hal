...
<div style="display: flex; justify-content: space-between; text-align: center;">
  <span style="width: 32%"><a href="examples\peripherals\uart-cli-demo">UART CLI Demo</a></span>
  <span style="width: 32%"><a href="examples\peripherals\pwm-demo">PWM Demo</a></span>
  <span style="width: 32%"><a href="examples\peripherals\spi-demo">SPI Demo</a></span>
</div>

<div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
  <img src="docs/uart-cli-demo.gif" width="32%" alt="UART CLI Demo">
  <img src="docs/pwm-demo.gif" width="32%" alt="PWM Demo">
  <img src="docs/spi-demo.gif" width="32%" alt="SPI Demo">
</div>
